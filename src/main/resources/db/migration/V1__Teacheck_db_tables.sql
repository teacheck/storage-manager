...
CREATE TABLE alarma(
    ...
    tipo VARCHAR(100),
    descripcion VARCHAR (100),
    correlacion_asistencia DECIMAL(10,9),
    correlacion_nota DECIMAL(10,9),
    correlacion_entregable DECIMAL(10,9),
    correlacion_entregable_nota DECIMAL(10,9),
    correlacion_horas DECIMAL(10,9),
    correlacion_atp DECIMAL(10,9),
    correlacion_motp DECIMAL(10,9),
    correlacion_ata DECIMAL(10,9),
    correlacion_mota DECIMAL(10,9)
);
